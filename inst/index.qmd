...
This book provides interactive examples and discussion on the key principles of computational analysis workflows for spatial transcriptomics data, using [Bioconductor](http://bioconductor.org/) in R. The book contains chapters describing individual analysis steps and extended workflows, with examples including R code and datasets.

The book is organized into several parts, including introductory materials, and analysis steps and workflows for both sequencing-based and imaging-based spatial transcriptomics platforms.
