...
knitr::include_graphics("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/images/spatialLIBD_interactive_cluster.png")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/images/spatialLIBD_gene_grid.png")
```
...
Ok, let's get started! First we need to re-create the `spe` object from the @sec-human-dlpfc-workflow in the previous chapter. That chapter included code for visualizing results along the way, which we'll skip here. Thus, we'll use the following packages in addition to `spatialLIBD`:
...
We can now run the following R code to re-make the `spe` object from the @sec-human-dlpfc-workflow. This will take a bit of time.
...
knitr::include_graphics("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/images/spatialLIBD_demo_result.png")
```
...
cat(paste0(readLines("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/spatialLIBD_demo/app.R"), "\n"))
```
...
knitr::include_graphics("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/images/spatialLIBD_publish.png")
```
...
cat(paste0(readLines("https://raw.githubusercontent.com/lmweber/BestPracticesST-resources/main/spatialLIBD_demo/deploy.R"), "\n"))
```
...
* we re-used the `spe` object from the @sec-human-dlpfc-workflow chapter,
