...
Alternatively, we can apply methods to identify spatially variable genes (SVGs) instead of HVGs. For more details and an example showing how to identify SVGs using `nnSVG` [@Weber2023], see @sec-crs-spatially-variable-genes.
