...
The resulting $\text{#cells}\times\text{#clusters}$ probability matrix can, in turn, be used to assess co-occurrence of subpopulations. 
...
To perform neighborhood co-localization analysis, `plotColocal()` computes the Pearson correlation on the probability distribution of each cell.
