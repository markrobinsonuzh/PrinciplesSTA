# Workflows for sequencing-based data {#sec-seq-workflows}
...
For more details on the individual analysis steps, see the chapters in the previous part (@sec-seq-analysis-steps).
