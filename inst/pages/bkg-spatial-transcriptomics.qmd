...
A preprint describing the platform applied to human colorectal cancer samples is available from 10x Genomics [@Oliveira2024].
...
Imaging-based platforms (also referred to as molecule-based platforms) identify the spatial locations of individual RNA molecules by sequential in situ hybridization (ISH) or by in situ sequencing (ISS), for targeted sets of up to hundreds or thousands of genes at single-cell or sub-cellular spatial resolution.
