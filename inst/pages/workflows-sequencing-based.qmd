# Workflows: sequencing-based data {#sec-workflows-sequencing-based}

This part contains several extended chapters containing examples of analysis workflows for data from sequencing-based platforms.
