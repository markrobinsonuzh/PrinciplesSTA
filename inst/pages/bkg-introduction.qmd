...
This book provides discussion and interactive examples on computational analysis workflows for spatial transcriptomics data, using the [Bioconductor](http://bioconductor.org/) framework within R.
...
We welcome suggestions for updates and additions to the book. Suggestions may be provided as [GitHub issues](https://github.com/lmweber/PrinciplesSTA/issues) for further discussion with the maintainers.
