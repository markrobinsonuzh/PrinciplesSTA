...
```{r spe-schematic, fig.wide=TRUE, echo=FALSE, fig.cap="Overview of the `SpatialExperiment` object class for storing spatially resolved transcriptomics datasets in the Bioconductor framework."}
