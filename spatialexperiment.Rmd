...
```{r spe-schematic, fig.width=3.5, echo=FALSE, fig.cap="Overview of the `SpatialExperiment` object class for storing spatially resolved transcriptomics datasets in the Bioconductor framework."}
