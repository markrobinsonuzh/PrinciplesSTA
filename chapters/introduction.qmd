...
This book provides examples and discussion on best practices for computational analysis workflows for spatial transcriptomics data, using the [Bioconductor](http://bioconductor.org/) framework within R.
...
- **Workflows:** complete analysis workflows for several example datasets

- **Appendix:** related resources, contributors, and references
...
- The [Orchestrating Single-Cell Analysis with Bioconductor (OSCA)](https://osca.bioconductor.org/) book [@Amezquita2020], which contains comprehensive resources on analysis workflows for single-cell data, as well as additional introductory material on R and Bioconductor.
...
[Bioconductor](http://bioconductor.org/) is an *open source* and *open development* project, providing a cohesive and flexible framework for analyzing high-throughput genomic data in R [@Huber2015]. The Bioconductor project consists of more than 2,000 contributed R packages, as well as core infrastructure maintained by the Bioconductor Core Team, providing a rich analysis environment for users.
