...
`MoleculeExperiment` is available as a [Bioconductor package](https://bioconductor.org/packages/MoleculeExperiment) and described in detail in a paper by @CoutoPeters2023.
