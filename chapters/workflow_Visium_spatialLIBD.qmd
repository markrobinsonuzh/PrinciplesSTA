...
knitr::include_graphics("https://github.com/lmweber/BestPracticesST-resources/blob/427dc1b8c1f5cffc0bc089f738bd43b5ab1bc073/images/spatialLIBD_interactive_cluster.png")
```
...
knitr::include_graphics("https://github.com/lmweber/BestPracticesST-resources/blob/427dc1b8c1f5cffc0bc089f738bd43b5ab1bc073/images/spatialLIBD_gene_grid.png")
```
...
Ok, let's get started! First we need to re-create the `spe` object from the @sec-workflow-human-dlpfc in the previous chapter. That chapter included code for visualizing results along the way, which we'll skip here. Thus, we'll use the following packages in addition to `spatialLIBD`:
...
We can now run the following R code to re-make the `spe` object from the @sec-workflow-human-dlpfc. This will take a bit of time.
...
knitr::include_graphics("https://github.com/lmweber/BestPracticesST-resources/blob/427dc1b8c1f5cffc0bc089f738bd43b5ab1bc073/images/spatialLIBD_demo_result.png")
```
...
knitr::include_graphics("https://github.com/lmweber/BestPracticesST-resources/blob/427dc1b8c1f5cffc0bc089f738bd43b5ab1bc073/images/spatialLIBD_publish.png")
```
...
cat(paste0(readLines("https://github.com/lmweber/BestPracticesST-resources/blob/427dc1b8c1f5cffc0bc089f738bd43b5ab1bc073/spatialLIBD_demo/deploy.R"), "\n"))
```

Note that we have copied the default [`www` directory files from the `spatialLIBD` repository](https://github.com/LieberInstitute/spatialLIBD/tree/master/inst/app/www) and [adapted them to our liking]((https://github.com/lmweber/BestPracticesST-resources/tree/main/spatialLIBD_demo/www)). We then use these files with `spatialLIBD::run_app(docs_path)` in our `app.R` script. These files help us control portions of our `spatialLIBD`-powered website and customize it to our liking.
...
* we re-used the `spe` object from the @sec-workflow-human-dlpfc chapter,
